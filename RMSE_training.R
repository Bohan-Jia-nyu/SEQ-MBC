...
sqrt(sum((estimated_total_work - outcome3_pred_dat1$total_work)^2)/570)
sqrt(sum((rep(estimated_total_work,570) - outcome3_pred_dat1$total_work)^2)/570)

sqrt(( sum((rep(dat_pred_par2$estimate["mean1"],570)-outcome3_pred_dat1$total_work)^2)*
         dat_pred_par2$estimate["p_outcome[1]"]+
         sum((rep(dat_pred_par2$estimate["mean2"],570)-outcome3_pred_dat1$total_work)^2)*
         dat_pred_par2$estimate["p_outcome[2]"]+
         sum((rep(dat_pred_par2$estimate["mean3"],570)-outcome3_pred_dat1$total_work)^2)*
         dat_pred_par2$estimate["p_outcome[3]"] )/570)
...
sqrt(( sum((rep(dat_pred_par2$estimate["mean1"],570)-outcome3_pred_dat1$total_work)^2)*
         ...
         sum((rep(dat_pred_par2$estimate["mean4"],570)-outcome3_pred_dat1$total_work)^2)*
         dat_pred_par2$estimate["p_outcome[4]"])/570)
...
estimated_total_work<-
  ...
  matrix(c(dat_pred_par2$estimate["p_class1[1]"],dat_pred_par2$estimate["p_class1[2]"],dat_pred_par2$estimate["p_class1[3]"],dat_pred_par2$estimate["p_class1[4]"],dat_pred_par2$estimate["p_class1[5]"],
           dat_pred_par2$estimate["p_class2[1]"],dat_pred_par2$estimate["p_class2[2]"],dat_pred_par2$estimate["p_class2[3]"],dat_pred_par2$estimate["p_class2[4]"],dat_pred_par2$estimate["p_class2[5]"],
           dat_pred_par2$estimate["p_class3[1]"],dat_pred_par2$estimate["p_class3[2]"],dat_pred_par2$estimate["p_class3[3]"],dat_pred_par2$estimate["p_class3[4]"],dat_pred_par2$estimate["p_class3[5]"],
           dat_pred_par2$estimate["p_class4[1]"],dat_pred_par2$estimate["p_class4[2]"],dat_pred_par2$estimate["p_class4[3]"],dat_pred_par2$estimate["p_class4[4]"],dat_pred_par2$estimate["p_class4[5]"],
           dat_pred_par2$estimate["p_class5[1]"],dat_pred_par2$estimate["p_class5[2]"],dat_pred_par2$estimate["p_class5[3]"],dat_pred_par2$estimate["p_class5[4]"],dat_pred_par2$estimate["p_class5[5]"]),
         byrow = FALSE,ncol=5)%*%
  as.matrix(prob)
sqrt(sum((estimated_total_work - outcome3_pred_dat1$total_work)^2)/570)
sqrt(sum((rep(estimated_total_work,570) - outcome3_pred_dat1$total_work)^2)/570)
...
sqrt(( sum((rep(dat_pred_par2$estimate["mean1"],570)-outcome3_pred_dat1$total_work)^2)*
         ...
         sum((rep(dat_pred_par2$estimate["mean5"],570)-outcome3_pred_dat1$total_work)^2)*
         dat_pred_par2$estimate["p_outcome[5]"])/570)
